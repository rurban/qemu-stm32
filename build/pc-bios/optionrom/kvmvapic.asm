# 1 "/data/software/qemu/pc-bios/optionrom/kvmvapic.S"
# 1 "<built-in>"
# 1 "<command-line>"
...
.macro read_fw VAR
 ...
 bswap %eax
.endm
# 13 "/data/software/qemu/pc-bios/optionrom/kvmvapic.S" 2
...
.text 1
 fixup_end = .
.text 0
# 328 "/data/software/qemu/pc-bios/optionrom/kvmvapic.S"
.text 2
